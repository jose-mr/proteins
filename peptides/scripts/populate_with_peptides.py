...
def run():
    ...
    # Add Uniprot entries from file
    PEPTIDES_UNIPROT_FILE = DATA_FOLDER / "peptides/uniprot/uniprot_peptides.dat.gz"
    Entry.create_from_dat_file(PEPTIDES_UNIPROT_FILE)
